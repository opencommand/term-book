...
2. **Report the issue privately.** 📨
   - Please email us at: [<!-- email -->](<!-- email -->) or use our secure issue reporting system on [our GitHub repository](https://github.com/opencommand/term-book/security).
...
- [Security Advisories](https://github.com/opencommand/term-book/security/advisories)
